    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria_platillo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='platillos', to='restaurant_application.CategoriaPlatillo')),
            ],
        ),
        migrations.CreateModel(
            name='Puesto',
